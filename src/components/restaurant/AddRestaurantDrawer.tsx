            ...
            {isOpen && (
                <div className="fixed inset-0 z-[2000] flex items-end justify-center">
                    ...
                    <motion.div
                        ...
                        className="relative bg-white w-full max-w-lg rounded-t-[32px] p-6 shadow-2xl overflow-hidden"
                    >
                                    ...
                                    >
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    type="text"
                                                    className="w-full bg-slate-50 border-none rounded-2xl p-4 pl-12 focus:ring-2 focus:ring-pastel-blue outline-none transition-all"
                                ...
                                {step === 3 && (
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            className={`w-full p-4 rounded-2xl border-2 flex items-center justify-between transition-all ${formData.isFavorite ? 'bg-pastel-pink/10 border-pastel-pink text-slate-800 shadow-sm' : 'bg-white border-slate-100 text-slate-400'}`}
                                        >
