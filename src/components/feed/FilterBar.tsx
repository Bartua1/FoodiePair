    ...
    return (
        <div className="flex gap-2 overflow-x-auto px-1 no-scrollbar scroll-smooth items-center">
            ...
            <select
                ...
                className="flex-none px-4 py-2 rounded-full border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-sm font-medium text-slate-500 dark:text-zinc-400 outline-none focus:ring-2 focus:ring-pastel-mint"
            >
            ...
            {/* Price Filter */}
            <div className="flex-none flex bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 rounded-full p-1">
                {[1, 2, 3].map((p) => (
                    <button
                        key={p}
